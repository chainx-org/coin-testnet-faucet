...
function Content(): React.ReactElement {
  const coinList: string[] = ['PCX (sherpax 相关网络)', 'PCX (chainx 主测试网)'];
        ...
        <div className='flex flex-col justify-center w-full'>
          ...
          <div className='flex relative'>
            <div onClick={() => setIsShow(!isShow)}
              ...
              <span>{coinSelected === '' ?
                <span className='text-black-light'>Select a token</span> : coinSelected}</span>
